...
#OPEN OUTPUT.XLS
wb = open_workbook('output - facebook.xls',formatting_info=True)
...
browser.form['email'] = '####U/N####'
browser.form['pass'] = '####P/W####'
browser.submit()

#DEFINING URLS
TA1 = 'https://www.facebook.com/TARGET1'
TA2 = 'https://www.facebook.com/TARGET2'
TA3 = 'https://www.facebook.com/TARGET3'
